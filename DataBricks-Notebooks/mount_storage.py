...
dbutils.fs.mount(
  source = "abfss://raw@covid19adlls274.dfs.core.windows.net/",
  mount_point = "/mnt/covid19adlls274/raw",
...
dbutils.fs.mount(
  source = "abfss://processed@covid19adlls274.dfs.core.windows.net/",
  mount_point = "/mnt/covid19adlls274/processed",
  extra_configs = configs)
...
dbutils.fs.mount(
  source = "abfss://lookup@covid19adlls274.dfs.core.windows.net/",
  mount_point = "/mnt/covid19adlls274/lookup",
  extra_configs = configs)
